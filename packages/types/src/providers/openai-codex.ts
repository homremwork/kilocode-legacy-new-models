...
export const openAiCodexModels = {
	...
	"gpt-6-sol": {
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-6 Sol: Workhorse model for coding and everyday work via ChatGPT subscription",
	},
	"gpt-6-luna": {
		maxTokens: 128000,
		contextWindow: 272000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-6 Luna: Fast model for easier tasks via ChatGPT subscription",
	},
	"gpt-5.6-sol": {
		maxTokens: 128000,
	...
	"gpt-5.6-terra": {
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Terra: Balanced agentic coding model via ChatGPT subscription",
	},
	"gpt-5.6-luna": {
		maxTokens: 128000,
		contextWindow: 372000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Luna: Fast agentic coding model via ChatGPT subscription",
	},
	"gpt-5.5": {
		maxTokens: 128000,
