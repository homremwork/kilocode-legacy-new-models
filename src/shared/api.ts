...
export const getModelMaxOutputTokens = ({
	...
	// Codex backend does not receive max_output_tokens. Reserve a one-token sentinel
	// so legacy context-management code uses the full 90% context budget.
	if (settings?.apiProvider === "openai-codex") {
		return 1
	}
